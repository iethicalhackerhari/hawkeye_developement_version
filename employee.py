...
class Employee :
    def __init__(self, root) :
        ...
        # current course
        current_course_frame=LabelFrame(Left_frame, bd=2, bg="white", relief=RIDGE, text="Personal Details")
        current_course_frame.place(x=5,y=5, width=645, height=150)
        
        
        # Employee ID
        emp_id_label=Label(current_course_frame,  text="ID", font=("times new roman", 9))
        emp_id_label.grid(row=0, column=0)
        
        emp_id_combo=ttk.Entry(current_course_frame,textvariable=self.emp_id, font=("times new roman", 12, "bold"),width=17) 
        emp_id_combo.grid(row=0, column=1, padx=10, pady= 3)
        
        # Employee name 
        emp_name_label=Label(current_course_frame,  text="Name ", font=("times new roman", 9))
        emp_name_label.grid(row=0, column=2)
        
        emp_name_combo=ttk.Entry(current_course_frame,textvariable=self.name, font=("times new roman", 12, "bold"),width=17) 
        emp_name_combo.grid(row=0, column=3, padx=10, pady= 3)
        
         # Employee email 
        emp_email_label=Label(current_course_frame, text="E-Mail ", font=("times new roman", 9))
        emp_email_label.grid(row=1, column=0, padx=3)
        
        emp_email_combo=ttk.Entry(current_course_frame,textvariable=self.email, font=("times new roman", 12, "bold"),width=17)
        emp_email_combo.grid(row=1, column=1, padx=10, pady= 10)
        
        
        # Department name 
        dep_label=Label(current_course_frame, text="Department ", font=("times new roman", 9))
        dep_label.grid(row=1, column=2)
        
        dep_combo=ttk.Combobox(current_course_frame,textvariable=self.dept, font=("times new roman", 12, "bold"),width=17, state="readonly", )
        ...
        save_btn=Button (button_frame, command=self.add_data, text="Save", width=15, font= ("times new roman", 13, "bold ") , bg="cyan", fg="black")
        save_btn.grid(row=0, column=0)
        
        update_btn=Button(button_frame, text="Update ",command=self.update_details, width=15, font=("times new roman",13, "bold"), bg="cyan", fg="black")
        update_btn.grid (row=0, column=1, padx=5)
        
        delete_btn=Button (button_frame, text= "Delete",command=self.delete_details, width=15, font= ("times new roman", 13, "bold"), bg="cyan", fg="black")
        delete_btn.grid (row=0, column=2, padx=5)
        
        reset_btn=Button (button_frame, text= "Reset", width=15, font=("times new roman", 13, "bold"), bg="cyan", fg="black")
        reset_btn.grid (row=0, column=3, padx=5)
        
        take_photo_btn=Button (button_frame, text= "Take Photo",command=self.generate_daraset, width=15, font=("times new roman", 13, "bold"), bg="cyan", fg="black")
        take_photo_btn.grid (row=1, column=1,pady=5, padx=5)
        
        update_photo_btn=Button (button_frame, text= "Update Photo", width=15, font=("times new roman", 13, "bold"), bg="cyan", fg="black")
        ...
        search_box_frame=LabelFrame(Right_frame, bd=2, bg="white", relief=RIDGE, text="Search By")
        search_box_frame.place(x=5,y=5, width=645, height=150)
        
        search_combo=ttk.Combobox(search_box_frame, font=("times new roman", 12, "bold"),width=17, state="readonly", )
        
        search_combo["values"]=("Select Department", "Computer", "IT")
        search_combo.grid(row=0, column=1, padx=10, pady= 3)
        
        search_inp=ttk.Entry(search_box_frame, font=("times new roman", 12, "bold"),width=17)
        search_inp.grid(row=0, column=2, padx=10, pady= 10)
 
        reset_btn=Button (search_box_frame, text= "Search", width=15, font=("times new roman", 13, "bold"), bg="cyan", fg="black")
